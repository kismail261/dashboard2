                ...
                <div class="span12">
                    ...
                    <div id="frameworks-tab-content" class="plan-projects tab-data hide">
                        ...
                        <div class="status-tabs" >
                            ...
                            <div id="active-frameworks" class="table-responsive custom-treegrid-container">
                            ...
                            if (get_frameworks_count(1) === "0")
                            {
                                ...
                                echo "<h4>Try one of the following ways to load frameworks into GRCfy:</h4>\n";
                                echo "<ol>\n";
                                echo "  <li>Click the plus (+) icon above to manually create a new framework.</li>\n";
                                echo "  <li><a href=\"../admin/register.php\">Register</a> your GRCfy instance to download the free ComplianceForge SCF Extra and <a href=\"../admin/complianceforge_scf.php\">select from 196 different frameworks</a> that have been expertly mapped against 1090 security and privacy controls.</li>\n";
...
<!-- MODE WINDOW FOR EDITING FRAMEWORK -->
