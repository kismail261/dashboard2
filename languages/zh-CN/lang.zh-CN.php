...
$lang = array(
    ...
    'AssetValue'=>'资产的价值',
    'Register'=>'登记册',
    'RegisterGRCfy'=>'登记册GRCfy',
    'RegistrationText'=>'注册的简单风险实例将立即被授予对升级和合规性锻造 SCF 附加项的访问权限。 升级额外功能通过单击按钮即可备份和升级 GRCfy 实例。 合规性锻造 SCF Extra 提供了一个与简单风险治理功能集成的通用控制框架。 注册 GRCfy 后，您的注册信息将发送到 GRCfy 托管的服务器。 GRCfy 将使用提供的注册信息通知客户新版本和安全更新。 注册 GRCfy 的行为将选择您加入我们的营销通信，但您可以随时使用这些通信中的取消订阅链接选择退出。 GRCfy 尊重客户的隐私，通过简单风险注册流程提供给我们的信息绝不会出售给第三方。',
    'RegistrationInformation'=>'登记资料',
    'Company'=>'公司',
    'JobTitle'=>'工作权',
    'Phone'=>'电话',
    'UpgradeGRCfy'=>'提高GRCfy',
    ...
    'CustomExtrasText'=>'那将是太棒了如果一切都是免费的，对吧？ 希望的核心GRCfy纲要》能够成你所有的风险管理的需要。 但如果你发现自己仍有希望得到更多的功能，我们已经制定了一系列的"额外"，将做到这一点。',
    'Upgrade'=>'升级',
    'Install'=>'安装',
    'Purchase'=>'购买',
    'PasswordPolicy'=>'密码政策',
    ...
    'UnauthenticatedAccessInAPI' => '未经身份验证的访问。 请登录或提供要使用 GRCfy API 密钥。',
    ...
    'ImportCsvXlsFile' => '将以下 CSV 或 XLS 文件导入 GRCfy',
    ...
    'GRCfyActionNotifications' => 'GRCfy 操作通知',
    'WhenToNotify' => '何时通知',
    'WhoToNotify' => '谁通知',
    'HowToNotify' => '如何通知',
    ...
    'GRCfyScheduledNotifications' => 'GRCfy 计划的通知',
    ...
    'YouNeedToUpgradeYourGRCfySubscription' => '您需要升级您的 GRCfy 订阅, 以启用此额外的使用。',
    ...
    'CacheClearWarning' => '通常,新的 GRCfy 版本会为可能由 Web 浏览器缓存的样式表、图像和 javascript 提供更新。 请清除浏览器缓存,以确保 GRCfy 在升级后看起来应该如此。',
    'TestAddHeader' => '添加新测试',
    'TestEditHeader' => '更新测试',
    ...
    'JiraWebhookNotSupportedOnHttp' => '您必须在 https 上运行 GRCfy 实例才能使用此额外实例。',
    ...
    'JiraCreateRiskOnNewIssue' => '当检测到新的 Jira 问题时，允许 GRCfy 创建新风险。',
    'JiraScanProjectsForNewIssues' => '扫描项目',
    'JiraScanProjectsForNewIssuesInstructions' => 'GRCfy 将检查这些项目的新产品。',
    ...
    'GrantAdmin' => '授予管理员',
    'RemoveAdmin' => '删除管理员',
    'WouldYouLikeGRCfyToAutomaticallyGenerate' => '是否希望 GRCfy 根据选定的框架和控件自动生成调查表模板？',
    ...
    'FixFileEncodingIssuesDisclaimer' => '我们已检测到存储在您的 GRCfy 数据库中的文件可能的问题。下表将显示哪些项目有损坏的文件，需要更正。请查看列出的项目，然后重新上传受影响的文件。',
    'AttachmentType' => '附件类型',
    'FileName' => '文件名',
    'Upload' => '上传',
    ...
    'InvalidSimpleriskBaseUrl' => '无效的GRCfy基本URL！',
    'Questionnaire' => '问卷',
    ...
    'Back' => '后退',
    'UnableToCommunicateWithTheGRCfyServer' => '无法与GRCfy服务器通信',
    'Fields' => '领域',
    ...
    'LogoutFromRemoteSessions' => '注销会终止 GRCfy 会话并将用户从 SAML 身份提供程序 (IdP) 中注销',
    ...
    'ExportToXLSByClickingBelow' => '通过单击下面导出到 XLS 文件',
    'ExportToXLSXByClickingBelow' => '通过单击下面导出到 XLSX 文件',
    'ImportCsvXlsXlsxFile' => '将以下 CSV 或 XLS/XLSX 文件导入 GRCfy',
    'Notifications' => '通知',
    'IncidentManagementNotification_SectionHeader_new' => '通知新事件',
    'IncidentManagementNotification_SectionHeader_status_changed' => '状态变化通知',
    'IncidentManagementNotification_SectionHeader_summary_changed' => '通知摘要更改',
    'IncidentManagementNotification_SectionHeader_playbook_changed' => '通知剧本更改',
    'IncidentManagementNotification_SectionHeader_details_changed' => '通知细节变化',
    ...
    'IncidentManagementNotification_SectionHeader_all_recovery_steps_completed' => '通知所有已完成的恢复步骤',
    'IncidentManagementNotification_SectionHeader_evidence_attached' => '附上证据通知',
    'IncidentManagementNotification_SectionHeader_notes_added' => '通知已添加的注释',
    'IncidentManagementNotification_SectionHeader_lesson_learned_added' => '添加了关于经验教训的通知',
    'IncidentManagementNotification_Notify_reporter' => '通知记者',
    ...
    'IncidentManagementNotification_EmailSubject_new' => '新事件报告',
    'IncidentManagementNotification_EmailSubject_status_changed' => '事件状态已更改',
    'IncidentManagementNotification_EmailSubject_summary_changed' => '事件摘要已更改',
    'IncidentManagementNotification_EmailSubject_playbook_changed' => '事件剧本已更改',
    'IncidentManagementNotification_EmailSubject_details_changed' => '事件详情已更改',
    'IncidentManagementNotification_EmailSubject_all_containment_steps_completed' => '已完成所有事件遏制步骤',
    'IncidentManagementNotification_EmailSubject_all_eradication_steps_completed' => '已完成所有事件根除步骤',
    'IncidentManagementNotification_EmailSubject_all_recovery_steps_completed' => '已完成所有事件恢复步骤',
    'IncidentManagementNotification_EmailSubject_evidence_attached' => '事件中增加了新证据',
    'IncidentManagementNotification_EmailSubject_notes_added' => '添加到事件的新注释',
    'IncidentManagementNotification_EmailSubject_lesson_learned_added' => '事件中增加了新的经验教训',
    'NotSpecified' => '未指定',
    ...
    'SSLSecurityCheckWarning' => '警告：SSL 可防止 MITM 攻击，禁用以下选项是一个安全问题',
    'EnableSSLCertificateCheckGRCfy' => '为 GRCfy API 请求启用 SSL 证书检查',
    'EnableSSLCertificateCheckExternal' => '为外部网站启用 SSL 证书检查',
    'EnableSSLCertificateCheckVM' => '为漏洞管理启用 SSL 证书检查',
    'DuoToopherRemoved' => 'GRCfy 不再直接支持 Duo。相反，我们已迁移到通用 TOTP 身份验证器。请在下面设置您的新身份验证器。',
    'ProtectYourGRCfyAccount' => '保护您的 GRCfy 账户',
    '2FADescription' => '双因素身份验证通过使用辅助设备验证您的身份来增强您帐户的安全性。这可以防止除您以外的任何人访问您的帐户，即使他们知道您的密码。',
    '2FAStep1' => '第 1 步 - 使用 2FA 应用程序（例如 Google Authenticator）扫描下面的代码',
    '2FAStep2' => '第 2 步 - 在下方输入您的 2FA 应用程序中的代码以进行验证',
    'YourGRCfyAccountIsProtected' => '您的 GRCfy 账户受 MFA 保护。',
    'ToDisableMFA' => '要禁用 MFA，请验证您当前的 MFA 令牌并单击禁用按钮。',
    'MFAToken' => "MFA令牌",
    'RequireMFAForAllUsers' => '要求所有用户进行 MFA',
    'MFARequiredForAllusers' => '所有用户都需要 MFA，并且只能由管理员禁用。',
    'MFADisabledSuccessfully' => '已在您的帐户上成功禁用 MFA',
    'MFAEnabledSuccessfully' => '已在您的帐户上成功启用 MFA',
    'VerifyItsYou' => '通过在下面提供您的 MFA 令牌来验证您的身份：',
    ...
    'ConfirmDiscardAllAssets' => '您确定要丢弃所有未验证的资产吗？',
    'ConfirmDeleteAllAssets' => '您确定要删除所有经过验证的资产吗？',
    'EditFailed_NoPermission' => '编辑失败，没有权限。',
    'EditFailed_FieldMustBeUnique' => '编辑失败，字段“{$field}”的值必须是唯一的。',
    'EditFailed_NotSelected' => '编辑失败，未在 UI 上选择字段。',
    'EditFailed_IncorrectOrEmptyRequiredFields' => '编辑失败、不正确或为空的必填字段。',
    'EditFailed_RequiredFieldEmpty' => '编辑失败，必填字段“{$field}”不能为空。',
    'EditFailed_FieldNotEditable' => '编辑失败，无法编辑字段“{$field}”。',
    'EditFailed_CustomFieldNeedsCustomization' => '编辑失败，自定义字段只能在自定义附加功能激活时进行编辑。',
    ...
    'AreYouSureYouWantToDeactivateThisExtra' => '您确定要停用此 Extra 吗？',
    'Abort' => '中止',
    'UpdateComplianceForgeSCF' => '更新 ComplianceForge SCF 框架',
    'EnablingSelectedSCFMessage' => '启用选定的 ComplianceForge SCF 框架。这可能需要几秒钟才能完成。',
    'DisablingSelectedSCFMessage' => '禁用选定的 ComplianceForge SCF 框架。',
