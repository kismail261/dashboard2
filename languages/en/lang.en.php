...
$lang = array(
    ...
    'RegistrationText'=>'Registered GRCfy instances are immediately granted access to the Upgrade and ComplianceForge SCF Extras.  The Upgrade Extra provides the ability to back up and upgrade your GRCfy instance with the click of a button.  The ComplianceForge SCF Extra provides a common control framework that is integrated into the GRCfy Governance functionality.  Upon registering GRCfy, your registration information will be sent to a server hosted by GRCfy.  The registration information provided will be used by GRCfy to notify customers of new releases and security updates.  The act of registering GRCfy will opt you into our marketing communications, but you may opt out at any time using the unsubscribe link in these communications.  GRCfy respects the privacy of our customers and information provided to us through the GRCfy registration process will never be sold to a third-party.',
    ...
    'CustomExtrasText'=>'It would be awesome if everything were free, right?  Hopefully the core GRCfy platform is able to serve all of your risk management needs.  But, if you find yourself still wanting more functionality, we\'ve developed a series of "Extras" that will do just that.',
    'Upgrade'=>'Upgrade',
    'Install'=>'Install',
    'Purchase'=>'Purchase',
    ...
    'GRCfyColumnMapping' => 'GRCfy Column Mapping',
    'Mapping' => 'Mapping',
    'Optional' => 'Optional',
    ...
    'UnauthenticatedAccessInAPI' => 'Unauthenticated Access.  Please log in or provide a key to use the GRCfy API.',
    ...
    'ImportCsvXlsFile' => 'Import the following CSV or XLS file into GRCfy',
    ...
    'GRCfyActionNotifications' => 'GRCfy Action Notifications',
    ...
    'GRCfyScheduledNotifications' => 'GRCfy Scheduled Notifications',
    ...
    'YouNeedToUpgradeYourGRCfySubscription' => 'You need to upgrade your GRCfy subscription to enable use of this Extra.',
    ...
    'SimpleriskContributingRiskCalculator' => 'GRCfy Contributing Risk Calculator',
    ...
    'EncryptionBackupFileExists' => 'As part of the encryption process, an unencrypted backup copy of your GRCfy database has been created.  Once you have verified everything has encrypted properly, move it to a secure location or click the button to delete it.',
    ...
    'Asset' => 'Asset',
    'FailedToRegisterInstance' => 'Failed to register your GRCfy instance. Please contact support@simplerisk.com for assistance.',
    'FailedToUpdateInstance' => 'Failed to update your GRCfy registration. Please contact support@simplerisk.com for assistance.',
    ...
    'InstanceWasRegisteredWithDifferentIp' => 'Your GRCfy instance was registered with a different IP address. Please contact support@simplerisk.com for assistance.',
    'InstanceIsDisabled' => 'Your GRCfy instance is disabled. Please contact support@simplerisk.com for assistance.',
    'InvalidInstanceIdOrKey' => 'Your GRCfy instance or key is invalid. Please contact support@simplerisk.com for assistance.',
    ...
    'NextReviewDateFixDisclaimer' => 'We have detected a possible issue with the date formats stored in your GRCfy database.  The table below will show you which risks have an invalid date format and need to be corrected. Please take a look at the suspected date format, confirm that it is correct, and then click "Confirm" to have it updated in the database.',
    ...
    'CacheClearWarning' => 'Often times new GRCfy releases will provide updates to stylesheets, images, and javascript that may have been cached by your web browser.  Please clear your browser cache to ensure that GRCfy looks like it should after the upgrade.',
    ...
    'JiraWebhookNotSupportedOnHttp' => 'You have to run your GRCfy instance on https to be able to use this extra.',
    ...
    'JiraCreateIssueOnNewRisk' => 'Allow GRCfy to create new Jira issues when a Risk is created.',
    ...
    'JiraCreateRiskOnNewIssue' => 'Allow GRCfy to create new Risk when a new Jira issue is detected.',
    'JiraScanProjectsForNewIssues' => 'Scan Projects',
    'JiraScanProjectsForNewIssuesInstructions' => 'GRCfy will check these projects for new issues.',
    ...
    'JiraAllowWebhookManagement' => 'Allow the GRCfy instance to manage Webhooks on the Jira instance',
    ...
    'LicenseCheckFailed' => 'One or more of your GRCfy Extras has failed the license check and may be disabled or deleted within the next 30 days. Please contact support immediately to renew your license.',
    ...
    'FixFileEncodingIssuesDisclaimer' => 'We have detected a possible issue with files stored in your GRCfy database. The table below will show you which items have corrupt file(s) and need to be corrected. Please take a look at the listed items and re-upload the affected files.',
    ...
    'InvalidSimpleriskBaseUrl' => 'Invalid GRCfy Base URL!',
    'Questionnaire' => 'Questionnaire',
    ...
    'Back' => 'Back',
    'UnableToCommunicateWithTheGRCfyServer' => 'Unable to Communicate with the GRCfy Server',
    'Fields' => 'Fields',
    ...
    'LogoutFromRemoteSessions' => 'Logout terminates GRCfy session AND logs user out of the SAML Identity Provider (IdP)',
    ...
    'ImportCsvXlsXlsxFile' => 'Import the following CSV or XLS/XLSX file into GRCfy',
    ...
    'EnableSSLCertificateCheckGRCfy' => 'Enable SSL Certificate Checks for GRCfy API Requests',
    ...
    'DuoToopherRemoved' => 'Duo is longer supported by GRCfy directly. Instead, we have migrated to a generic TOTP authenticator. Please set up your new authenticator below.',
    'ProtectYourGRCfyAccount' => 'Protect Your GRCfy Account',
    ...
    'YourGRCfyAccountIsProtected' => 'Your GRCfy Account is protected with MFA.',
    ...
    'Abort' => 'Abort',
    'UpdateComplianceForgeSCF' => 'Update ComplianceForge SCF Framework',
    'EnablingSelectedSCFMessage' => 'Enabling the selected ComplianceForge SCF frameworks. This can take several seconds to complete.',
    'DisablingSelectedSCFMessage' => 'Disabling the selected ComplianceForge SCF frameworks.',
