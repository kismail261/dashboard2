...
$lang = array(
    ...
    'RegisterGRCfy'=>'Зарегистрировать GRCfy',
    'RegistrationText'=>'Зарегистрированным экземплярам GRCfy немедленно предоставляется доступ к обновлениям и соответствиюForge SCF Extras.  Обновление Дополнительно обеспечивает возможность резервного копирования и обновления экземпляра GRCfy одним нажатием кнопки.  ComplianceForge SCF Extra предоставляет общую систему управления, интегрированную в функциональность GRCfy Governance.  После регистрации GRCfy, ваша регистрационная информация будет отправлена на сервер, размещенный GRCfy.  Предоставляемая регистрационная информация будет использоваться GRCfy для уведомления клиентов о новых выпусках и обновлениях безопасности.  Акт регистрации GRCfy выберет вас в наших маркетинговых коммуникаций, но вы можете отказаться в любое время, используя ссылку отписаться в этих сообщениях.  GRCfy уважает конфиденциальность наших клиентов, и информация, предоставленная нам в процессе регистрации GRCfy, никогда не будет продана третьей стороне.',
    'RegistrationInformation'=>'Регистрационные Сведения',
    'Company'=>'Компания',
    'JobTitle'=>'Должность',
    'Phone'=>'Телефон',
    'UpgradeGRCfy'=>'GRCfy Обновления',
    ...
    'CustomExtrasText'=>'Было бы круто, если бы все было бесплатно, да? Надеюсь базовой платформы GRCfy способен обслуживать все Ваши потребности в управлении рисками. Но, если вы окажетесь желая еще больше функциональности, мы разработали серию "Экстра", которые будут делать именно это.',
    'Upgrade'=>'Обновление',
    'Install'=>'Установите',
    'Purchase'=>'Купить',
    ...
    'GRCfyColumnMapping' => 'Сопоставление Столбцов GRCfy',
    ...
    'UnauthenticatedAccessInAPI' => 'Доступ без проверки подлинности.  Пожалуйста войдите или предоставить ключ для использования GRCfy API.',
    ...
    'GRCfyActionNotifications' => 'Уведомления о действиях симплериск',
    ...
    'YouNeedToUpgradeYourGRCfySubscription' => 'Вам нужно обновить вашу симплериск подписаться, чтобы включить использование этого Extra.',
    ...
    'CacheClearWarning' => 'Часто новые релизы GRCfy будут предоставлять обновления для таблиц стилей, изображений и JavaScript, которые, возможно, были кэшированы вашего веб-браузера.  Пожалуйста, очистите кэш браузера, чтобы убедиться, что GRCfy выглядит так, как следует после обновления.',
    ...
    'JiraWebhookNotSupportedOnHttp' => 'Вы должны запустить ваш экземпляр GRCfy на https, чтобы иметь возможность использовать этот дополнительный.',
    ...
    'JiraCreateIssueOnNewRisk' => 'Разрешить GRCfy создавать новые проблемы Jira при создании риска.',
    ...
    'JiraCreateRiskOnNewIssue' => 'Разрешить GRCfy создавать новый риск при обнаружении новой проблемы Jira.',
    'JiraScanProjectsForNewIssues' => 'Проекты сканирования',
    'JiraScanProjectsForNewIssuesInstructions' => 'GRCfy проверит эти проекты на наличие новых выпусков.',
    ...
    'JiraAllowWebhookManagement' => 'Разрешить экземпляру GRCfy управлять Webhooks в экземпляре Jira',
    ...
    'AdminRoleDescription' => 'Это разрешение предоставляет доступ к конфигурациям GRCfy. Пользователь с таким разрешением фактически является административным пользователем системы. Они могут вносить изменения во все меню, найденные в меню "Configure". Это также позволит активации и деактивации дополнительных услуг и изменения их конфигураций. Это разрешение должно быть дано только тем, кто в нем абсолютно нуждается. Как только пользователь получит доступ к этому разрешению, он сможет редактировать и другие учетные записи пользователей.',
    'GrantAdmin' => 'Грант Администратор',
    'RemoveAdmin' => 'Удалить администратора',
    'WouldYouLikeGRCfyToAutomaticallyGenerate' => 'Хотите, чтобы GRCfy автоматически генерирует шаблон анкеты на основе выбранных фреймворка и элементов управления?',
    ...
    'LicenseCheckFailed' => 'Один или несколько ваших GRCfy Extras не удалось проверить лицензию и могут быть отключены или удалены в течение ближайших 30 дней. Пожалуйста, немедленно свяжитесь с поддержкой, чтобы продлить лицензию.',
    ...
    'FixFileEncodingIssuesDisclaimer' => 'Мы обнаружили возможную проблему с файлами, хранящимися в вашей базе данных GRCfy. В таблице ниже будет покажем вам, какие элементы имеют поврежденный файл (ы) и должны быть исправлены. Пожалуйста, взгляните на перечисленные элементы и пере загрузили затронутые файлы.',
    ...
    'InvalidSimpleriskBaseUrl' => 'Недействительный базовый URL GRCfy!',
    'Questionnaire' => 'Вопросник',
    ...
    'Back' => 'Назад',
    'UnableToCommunicateWithTheGRCfyServer' => 'Невозможно связаться с сервером GRCfy',
    'Fields' => 'Поля',
    ...
    'LogoutFromRemoteSessions' => 'Выход из системы прерывает сеанс GRCfy И выполняет выход пользователя из SAML Identity Provider (IdP)',
    ...
    'ImportCsvXlsXlsxFile' => 'Импортируйте следующий файл CSV или XLS/XLSX в GRCfy.',
    ...
    'EnableSSLCertificateCheckGRCfy' => 'Включить проверку SSL-сертификата для запросов API GRCfy',
    ...
    'DuoToopherRemoved' => 'Duo больше не поддерживается GRCfy напрямую. Вместо этого мы перешли на общий аутентификатор TOTP. Пожалуйста, настройте новый аутентификатор ниже.',
    'ProtectYourGRCfyAccount' => 'Защитите свою учетную запись GRCfy',
    ...
    'YourGRCfyAccountIsProtected' => 'Ваша учетная запись GRCfy защищена с помощью MFA.',
    ...
    'Abort' => 'Прервать',
    'UpdateComplianceForgeSCF' => 'Обновить ComplianceForge SCF Framework',
    'EnablingSelectedSCFMessage' => 'Включение выбранных платформ ComplianceForge SCF. Это может занять несколько секунд.',
    'DisablingSelectedSCFMessage' => 'Отключение выбранных фреймворков ComplianceForge SCF.',
