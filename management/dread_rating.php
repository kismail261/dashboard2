...
<html>
<head>
<title>GRCfy DREAD Calculator</title>
...
<script language="javascript" src="../js/grcfy/dread_scoring.js?<?php echo current_version("app"); ?>" type="text/javascript"></script>
...
<td align="left" valign="top"  bgcolor="#6B7782" >
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
  <td align="center" background="../images/cal-bg-head.jpg" height="35"><span class="heading">GRCfy DREAD Calculator</span></td>
</tr>
