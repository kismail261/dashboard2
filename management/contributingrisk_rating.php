...
<html>
<head>
<title>GRCfy Contributing Risk Calculator</title>
...
<script language="javascript" src="../js/grcfy/contributingrisk_scoring.js?<?php echo current_version("app"); ?>" type="text/javascript"></script>
