...
function get_framework_tabs($status)
{
    ...
    echo "<table class='table table-bordered text-nowrap border-bottom easyui-treegrid' id='responsiveDataTable'
            data-options=\"
                iconCls: 'icon-ok',
                animate: true,
                collapsible: false,
    ...
    echo "
        ...
        ."
            ...
            \">";
    echo "<thead >";
    echo "<th class='wd-20p' data-options=\"field:'name'\" width='20%'>".$escaper->escapeHtml($lang['FrameworkName'])."</th>";
    echo "<th class='wd-20p' data-options=\"field:'description'\" width='70%'>".$escaper->escapeHtml($lang['FrameworkDescription'])."</th>";
    echo "<th class='wd-20p' data-options=\"field:'actions'\" width='10%'>&nbsp;</th>";
    echo "</thead>\n";
    ...
    if($framework_ids)
    {
        ...
        foreach($framework_ids as $framework_id)
        {
            ...
            if($framework_id && !get_exist_mapping_control_framework($control_id, $framework_id))
            {
                ...
                write_debug_log("Adding GRCfy control id \"" . $control_id . "\" to framework id \"" . $framework_id . "\".");
            }
        }
...
/*function remove_framework_from_controls($framework_id)
{
    ...
    write_debug_log("Removing GRCfy framework id \"" . $framework_id . "\" from existing controls.");
