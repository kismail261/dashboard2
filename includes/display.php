...
////            echo "<a class=\"brand\" href=\"#/\"><img src='images/logo@2x.png' alt='GRCfy Logo' /></a>\n";
...
//            echo "</li>\n";
//            echo "<li>\n";
//            echo "<a href=\"https://github.com/simplerisk/documentation/raw/master/GRCfy%20Release%20Notes%20" . $escaper->escapeHtml(get_latest_app_version()) . ".pdf\" target=\"_blank\"><i class=\"fa fa-newspaper\"></i>&nbsp&nbsp;". $escaper->escapeHtml($lang['WhatsNew']) ."</a>\n";
//            echo "</li>\n";
//            echo "<li>\n";
...
function view_governance_menu($active)
{
    ...
    echo "<a href=\"importexport.php\"> <span>3</span> " . $escaper->escapeHtml($lang['ImportExport']) . "</a>\n";
    echo "</li>\n";

    if (check_permission_exception('view')) {
        echo ($active == "DocumentExceptions" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a href=\"document_exceptions.php\"> <span>4</span> " . $escaper->escapeHtml($lang['DocumentExceptions']) . "</a>\n";
        echo "</li>\n";
    }
    echo "</ul>\n";
}
...
function view_reporting_menu($active)
{
    ...
    echo "<ul class=\"nav nav-pills nav-stacked aside--nav \">\n";
    echo ($active == "Overview" ? "<li class=\"active\" style='background-color: #4deeea1a;border-radius: 5pxpx;'>\n" : "<li>\n");
...
function risk_average_baseline_metric($time = "day", $title = ""){
    ...
    // Set the timezone to the one configured for GRCfy
...
**********************************/
function display_new_sidebar($active, $url){
    echo'<div class="sticky">';
    echo'<aside class="app-sidebar">';
    echo'<div class="main-sidebar-header active">';
    echo'<a class="header-logo active" href="index.html">';
    echo'<img src="../images/logo@2x.png" class="main-logo  desktop-dark" alt="logo">';
    echo'<img src="../images/logo@2x.png" class="main-logo  desktop-dark-1" alt="logo">';
    echo'<img src="../images/logo@2x.png" class="main-logo  mobile-dark" alt="logo">';
    echo'<img src="../images/logo@2x.png" class="main-logo  mobile-dark-1" alt="logo">';
    echo'</a>';
    echo'</div>';
    echo'<div class="main-sidemenu">';
    echo'<div class="slide-left disabled" id="slide-left">';
    echo'<svg fill="#7b8191" width="24" height="24" viewBox="0 0 24 24">';
    echo'<path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z" />';
    echo'</svg></div>';
    ...
    {   
        ...
        echo'<svg class="ionicon side-menu__icon"';
        echo'viewBox="0 0 512 512">';
        echo'<title>Icons</title>';
        echo'<circle cx="256" cy="256" r="192" fill="none" stroke="currentColor"';
        echo'stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" />';
        echo'<circle cx="256" cy="256" r="64" fill="none" stroke="currentColor"';
        echo'stroke-miterlimit="10" stroke-width="32" />';
        echo'<path fill="none" stroke="currentColor" stroke-linecap="round"';
        echo'stroke-miterlimit="10" stroke-width="32"';
        echo'd="M224 192L171 85M288 192l53-107M327.55 255.81l119.41.13M299.09 313.13l72.25 95.06M184.45 255.81l-119.41.13M212.91 313.13l-72.25 95.06" />';
        echo'</svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Governance</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1" style="font-size:15px;"><a href="javascript:void(0)">Governance</a></li>';
        echo ($active == "DefineControlFrameworks" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../governance/index.php\"> " . $escaper->escapeHtml($lang['DefineControlFrameworks']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "DocumentProgram" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../governance/documentation.php\"> " . $escaper->escapeHtml($lang['DocumentProgram']) . "</a>\n";
        echo "</li>\n";

        echo ($active == "ImportExport" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../governance/importexport.php\">" . $escaper->escapeHtml($lang['ImportExport']) . "</a>\n";
        echo "</li>\n";

        if (check_permission_exception('view')) {
            echo ($active == "DocumentExceptions" ? "<li class=\"active\">\n" : "<li>\n");
            echo "<a class=\"slide-item\" href=\"../governance/document_exceptions.php\"> " . $escaper->escapeHtml($lang['DocumentExceptions']) . "</a>\n";
            echo "</li>\n";
        }
        echo "</ul>\n";
    }
    ...
    {   
        ...
        echo'<li class="slide">';
        echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
        echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><path d="M480.141 225.74c0-7.957-5.953-14.803-13.852-15.914l-39.098-5.536c-3.423-11.372-8.059-22.489-13.823-33.152l23.681-31.653c4.783-6.385 4.125-15.424-1.521-21.034L393.08 76.106c-5.631-5.617-14.686-6.253-21.034-1.463l-31.594 23.769c-10.663-5.726-21.794-10.334-33.189-13.742l-5.631-39.091c-1.126-7.869-7.972-13.793-15.929-13.793h-.029l-59.934.073c-7.964.007-14.803 5.961-15.914 13.837l-5.536 39.098c-11.394 3.445-22.511 8.081-33.152 13.83l-31.653-23.688c-6.385-4.79-15.424-4.11-21.034 1.521l-42.338 42.44c-5.631 5.646-6.26 14.693-1.47 21.041l23.769 31.602c-5.726 10.656-10.334 21.787-13.742 33.189l-39.091 5.624c-7.877 1.134-13.808 7.994-13.793 15.951l.073 59.956c.007 7.957 5.961 14.803 13.837 15.914l39.098 5.514c3.437 11.409 8.081 22.526 13.83 33.159L74.936 372.5c-4.768 6.377-4.118 15.417 1.521 21.048l42.44 42.331c5.646 5.631 14.686 6.275 21.041 1.463l31.602-23.754c10.678 5.719 21.809 10.327 33.189 13.735l5.624 39.083c1.134 7.884 7.972 13.808 15.907 13.808h.044l59.941-.073c7.957 0 14.803-5.953 15.929-13.852l5.514-39.098a177.721 177.721 0 0 0 33.159-13.823l31.653 23.681c6.407 4.768 15.417 4.11 21.048-1.521l42.331-42.433c5.631-5.631 6.26-14.686 1.463-21.048l-23.754-31.594c5.719-10.663 10.327-21.809 13.735-33.189l39.083-5.631c7.899-1.126 13.823-8.001 13.808-15.958l-.073-59.935zm-15.432 64.045-42.93 6.173a5.98 5.98 0 0 0-4.929 4.344c-3.554 13.003-8.805 25.685-15.607 37.694a5.998 5.998 0 0 0 .439 6.553l26.095 34.695c1.214 1.624 1.053 3.935-.38 5.383l-42.331 42.448c-1.433 1.433-3.745 1.624-5.383.38l-34.768-26.007a5.972 5.972 0 0 0-6.553-.41c-11.98 6.831-24.647 12.111-37.65 15.695a6.018 6.018 0 0 0-4.344 4.944l-6.07 42.945c-.278 2.019-2.019 3.525-4.066 3.525l-59.949.073h-.015a4.113 4.113 0 0 1-4.052-3.51l-6.18-42.93a5.989 5.989 0 0 0-4.352-4.929c-12.981-3.554-25.663-8.805-37.701-15.607a6.077 6.077 0 0 0-2.947-.775c-1.273 0-2.538.41-3.598 1.214l-34.703 26.095c-1.631 1.199-3.935 1.053-5.368-.38l-42.44-42.331c-1.448-1.433-1.616-3.745-.395-5.383l26.014-34.768a5.997 5.997 0 0 0 .41-6.553c-6.816-11.965-12.104-24.647-15.702-37.65a6.008 6.008 0 0 0-4.937-4.344l-42.945-6.07c-2.011-.278-3.525-2.019-3.532-4.066l-.073-59.941c0-2.033 1.514-3.788 3.525-4.074l42.923-6.18a6.002 6.002 0 0 0 4.922-4.344c3.576-13.018 8.827-25.707 15.607-37.708a6 6 0 0 0-.424-6.546l-26.102-34.703a4.12 4.12 0 0 1 .38-5.368l42.338-42.448c1.441-1.426 3.752-1.609 5.368-.388l34.761 26.014a5.999 5.999 0 0 0 6.553.41c11.987-6.816 24.654-12.104 37.665-15.709a5.985 5.985 0 0 0 4.33-4.929l6.078-42.945c.285-2.011 2.033-3.525 4.066-3.532l59.949-.073a4.144 4.144 0 0 1 4.081 3.525l6.173 42.923a5.969 5.969 0 0 0 4.344 4.922c13.003 3.569 25.685 8.82 37.694 15.607 2.077 1.163 4.666 1.002 6.553-.424l34.695-26.095a4.135 4.135 0 0 1 5.383.366l42.448 42.353a4.107 4.107 0 0 1 .38 5.361l-26.007 34.761a5.972 5.972 0 0 0-.41 6.553c6.831 12.009 12.111 24.683 15.695 37.657a6 6 0 0 0 4.944 4.337l42.945 6.078a4.108 4.108 0 0 1 3.525 4.059l.073 59.956c.012 2.029-1.509 3.784-3.513 4.077z"/><path d="M261.065 170.077a5.99 5.99 0 0 0-5.068-2.794 5.99 5.99 0 0 0-5.068 2.794L166.523 303.71a5.996 5.996 0 0 0-.176 6.099 6.013 6.013 0 0 0 5.244 3.101h168.803a6.023 6.023 0 0 0 5.251-3.101 5.997 5.997 0 0 0-.19-6.099l-84.39-133.633zm-78.606 130.839 73.537-116.424 73.53 116.424H182.459z"/><path d="M371.998 288.325c9.48-40.232-2.469-82.983-31.794-112.214-16.34-16.319-36.855-27.267-59.342-32.093l-7.782-12.322c-7.46-11.775-26.709-11.782-34.169.007l-7.696 12.186c-22.82 4.771-43.613 15.838-60.166 32.434-29.327 29.406-41.145 72.308-31.433 112.611l-16.149 25.571a20.177 20.177 0 0 0-.614 20.551 20.204 20.204 0 0 0 17.691 10.444h30.733c23.312 23.246 53.89 34.856 84.469 34.856 30.577 0 61.146-11.628 84.45-34.856h31.25a20.234 20.234 0 0 0 17.699-10.444 20.213 20.213 0 0 0-.614-20.551l-16.533-26.18zm-40.248-103.73c23.437 23.373 34.604 56.36 30.836 88.827L290.27 158.914c15.543 5.25 29.706 13.924 41.48 25.681zm-152.216.197c11.99-12.023 26.444-20.818 42.314-26.068l-72.879 115.402c-4.008-32.597 7.076-65.788 30.565-89.334zm9.916 160.707h132.579c-38.799 30.384-93.757 30.4-132.579 0zm189.194-16.236a8.198 8.198 0 0 1-7.197 4.242H140.545a8.227 8.227 0 0 1-7.204-4.242 8.216 8.216 0 0 1 .256-8.352l115.444-182.808a8.195 8.195 0 0 1 6.955-3.832 8.182 8.182 0 0 1 6.948 3.825L378.41 320.911a8.217 8.217 0 0 1 .234 8.352z"/><path d="M249.667 263.86h12.661l2.945-52.514h-18.55zm-.568 11.699h13.369v14.563h-13.369z"/></svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Risk Management</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1"><a href="javascript:void(0)">Risk Management</a></li>';
        echo ($active == "SubmitYourRisks" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../management/index.php\">" . $escaper->escapeHtml($lang['SubmitYourRisks']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "PlanYourMitigations" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../management/plan_mitigations.php\">" . $escaper->escapeHtml($lang['PlanYourMitigations']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "PerformManagementReviews" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../management/management_review.php\">" . $escaper->escapeHtml($lang['PerformManagementReviews']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "PrioritizeForProjectPlanning" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../management/prioritize_planning.php\">" . $escaper->escapeHtml($lang['PrioritizeForProjectPlanning']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "ReviewRisksRegularly" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../management/review_risks.php\">" . $escaper->escapeHtml($lang['ReviewRisksRegularly']) . "</a>\n";
        echo "</li>\n";
        echo "</ul>\n";
    }
    if (check_permission("compliance"))
    {   
        ...
        echo'<li class="slide">';
        echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
        echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" style="enable-background:new 0 0 96 96" xml:space="preserve"><path d="M29.689 26.851h-8.346a1.42 1.42 0 0 0-1.421 1.421v8.346a1.42 1.42 0 0 0 1.421 1.421h8.346a1.42 1.42 0 0 0 1.421-1.421v-8.346a1.422 1.422 0 0 0-1.421-1.421zm-1.421 8.346h-5.505v-5.505h5.505v5.505zm9.233-6.925a1.42 1.42 0 0 1 1.421-1.421h21.219a1.42 1.42 0 1 1 0 2.842H38.922a1.422 1.422 0 0 1-1.421-1.421zm0 8.345a1.42 1.42 0 0 1 1.421-1.421h21.219a1.42 1.42 0 1 1 0 2.842H38.922a1.422 1.422 0 0 1-1.421-1.421zm-7.812 9.233h-8.346a1.42 1.42 0 0 0-1.421 1.421v8.346c0 .784.636 1.421 1.421 1.421h8.346a1.42 1.42 0 0 0 1.421-1.421v-8.346a1.422 1.422 0 0 0-1.421-1.421zm-1.421 8.346h-5.505v-5.505h5.505v5.505zm9.233-6.925a1.42 1.42 0 0 1 1.421-1.421h21.219a1.42 1.42 0 1 1 0 2.841H38.922a1.42 1.42 0 0 1-1.421-1.42zm0 8.345c0-.784.636-1.421 1.421-1.421h21.219a1.42 1.42 0 1 1 0 2.842H38.922a1.42 1.42 0 0 1-1.421-1.421zm-7.812 9.234h-8.346a1.42 1.42 0 0 0-1.421 1.421v8.346c0 .784.636 1.421 1.421 1.421h8.346a1.42 1.42 0 0 0 1.421-1.421V66.27a1.422 1.422 0 0 0-1.421-1.42zm-1.421 8.345h-5.505V67.69h5.505v5.505zm24.424-6.925c0 .784-.636 1.421-1.421 1.421H38.922a1.42 1.42 0 1 1 0-2.842h12.349a1.422 1.422 0 0 1 1.421 1.421zm0 8.346c0 .784-.636 1.421-1.421 1.421H38.922a1.42 1.42 0 1 1 0-2.842h12.349a1.42 1.42 0 0 1 1.421 1.421zm27.474-3.276c.557.552.562 1.451.01 2.009L70.5 83.121a1.42 1.42 0 0 1-1.006.421h-.004a1.42 1.42 0 0 1-1.004-.416l-5.381-5.381a1.42 1.42 0 1 1 2.009-2.009l4.371 4.371 8.671-8.758a1.421 1.421 0 0 1 2.01-.009zm-7.107-9.977v-44.9a4.978 4.978 0 0 0-4.972-4.972H55.835V8.295a1.42 1.42 0 0 0-1.421-1.421H47.64c-1.132-2.767-3.827-4.617-6.899-4.617s-5.767 1.85-6.899 4.617h-6.774a1.42 1.42 0 0 0-1.421 1.421v3.196h-12.25a4.977 4.977 0 0 0-4.972 4.972v65.344a4.977 4.977 0 0 0 4.972 4.972h45.487c2.91 3.878 7.544 6.392 12.755 6.392 8.787 0 15.936-7.149 15.936-15.936 0-8.309-6.392-15.151-14.516-15.872zM28.49 9.716h6.383c.656 0 1.227-.45 1.381-1.088a4.6 4.6 0 0 1 4.488-3.529 4.6 4.6 0 0 1 4.488 3.529 1.421 1.421 0 0 0 1.381 1.088h6.383v6.392H28.49V9.716zM13.397 83.938a2.133 2.133 0 0 1-2.131-2.131V16.463c0-1.175.956-2.131 2.131-2.131h12.252v3.196a1.42 1.42 0 0 0 1.421 1.421h27.345a1.42 1.42 0 0 0 1.421-1.421v-3.196h12.252c1.175 0 2.131.956 2.131 2.131v44.899c-8.124.721-14.516 7.564-14.516 15.872 0 2.393.531 4.664 1.48 6.703H13.397zm58.241 6.392c-7.221 0-13.096-5.875-13.096-13.095 0-7.221 5.875-13.095 13.096-13.095s13.095 5.875 13.095 13.095c.001 7.221-5.874 13.095-13.095 13.095z"/></svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Compliance</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1"><a href="javascript:void(0)">Compliance</a></li>';
        echo ($active == "DefineTests" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../compliance/index.php\">" . $escaper->escapeHtml($lang['DefineTests']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "InitialAudits" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../compliance/audit_initiation.php\">" . $escaper->escapeHtml($lang['InitiateAudits']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "ActiveAudits" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../compliance/active_audits.php\">" . $escaper->escapeHtml($lang['ActiveAudits']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "PastAudits" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../compliance/past_audits.php\">" . $escaper->escapeHtml($lang['PastAudits']) . "</a>\n";
        echo "</li>\n";
        echo "</ul>\n";
    }
    // If the user has asset management permissions
    ...
    {   
        ...
        echo'<li class="slide">';
        echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
        echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 100 100"><path d="M81.58 63.435a3.006 3.006 0 0 0-1.031-4.512 20.358 20.358 0 0 0 2.967-8.355 1.2 1.2 0 0 0-.783-1.219 10.08 10.08 0 0 1-1.883-1.106 7.245 7.245 0 0 0-3.585-1.614 3.109 3.109 0 0 0-.647.051V36.029l2.45 1.546a5.813 5.813 0 0 0 6.2-9.831L49.532 5.185a1.2 1.2 0 0 0-1.279 0L12.511 27.744a5.813 5.813 0 0 0 6.205 9.831l2.451-1.546v23.294L17.09 63.4a2.244 2.244 0 0 0 0 3.17l.919.919q-.224.487-.412.992H16.3a2.243 2.243 0 0 0-2.241 2.241v5.786a2.243 2.243 0 0 0 2.241 2.241h1.3q.188.5.412.992l-.919.919a2.243 2.243 0 0 0 0 3.17l4.091 4.091a2.244 2.244 0 0 0 3.17 0L25.27 87q.488.224.992.412v1.3a2.243 2.243 0 0 0 2.238 2.242h5.786a2.243 2.243 0 0 0 2.241-2.241v-1.3c.336-.124.667-.262.992-.411l.919.919a2.243 2.243 0 0 0 3.17 0L45.7 83.83a2.219 2.219 0 0 0 .621-1.968h7.391a10.222 10.222 0 0 0 1.143 5.868C57.952 93.09 65.76 95 72.035 95c6.265 0 14.065-1.91 17.159-7.27 3.12-5.404-1.483-17.437-7.614-24.295Zm-16.862-1.2a.622.622 0 0 1 0-1.244h14.464a.622.622 0 0 1 0 1.244Zm14.787-12.01c.5.338 1.006.683 1.525.967a19.929 19.929 0 0 1-3.106 7.4H66.165a18.03 18.03 0 0 1-3.326-7.6 8.108 8.108 0 0 0 1.841-1.246c.6-.5 1.222-1 1.685-1a6.236 6.236 0 0 1 2.3 1.2 7.236 7.236 0 0 0 3.585 1.614 5.038 5.038 0 0 0 3.267-1.54c.6-.5 1.229-1.007 1.684-1a6.246 6.246 0 0 1 2.304 1.205ZM17.438 35.55a3.417 3.417 0 1 1-3.648-5.78l35.1-22.156L84 29.77a3.417 3.417 0 0 1-3.648 5.78L49.532 16.1a1.2 1.2 0 0 0-1.279 0Zm31.454-17.021 25.33 15.988v13.469L74 48.17c-.6.5-1.231 1-1.684 1a6.251 6.251 0 0 1-2.3-1.2 7.235 7.235 0 0 0-3.586-1.614 5.015 5.015 0 0 0-3.266 1.54 3.792 3.792 0 0 1-1.638 1 1.2 1.2 0 0 0-1.142 1.2c.017 2.93 1.457 6.214 3.084 8.778a3.007 3.007 0 0 0-.946 4.8 38.89 38.89 0 0 0-4.36 5.9V50.679a1.2 1.2 0 0 0-1.2-1.2H40.824a1.2 1.2 0 0 0-1.2 1.2v8.011a2.222 2.222 0 0 0-1.185.619l-.919.919q-.487-.224-.992-.412v-1.3a2.244 2.244 0 0 0-2.241-2.242H28.5a2.244 2.244 0 0 0-2.241 2.242v1.3q-.5.188-.992.412l-.919-.919a2.211 2.211 0 0 0-.789-.508V34.517Zm-8.866 67.59L38.608 84.7a1.2 1.2 0 0 0-1.411-.21 12.294 12.294 0 0 1-2.213.918 1.2 1.2 0 0 0-.849 1.146v2h-5.478v-2a1.2 1.2 0 0 0-.849-1.146 12.252 12.252 0 0 1-2.213-.918 1.2 1.2 0 0 0-1.411.21l-1.418 1.418-3.874-3.874 1.418-1.418a1.2 1.2 0 0 0 .21-1.411 12.294 12.294 0 0 1-.92-2.215 1.2 1.2 0 0 0-1.146-.849h-2v-5.475h2a1.2 1.2 0 0 0 1.146-.85 12.2 12.2 0 0 1 .917-2.212 1.2 1.2 0 0 0-.21-1.411l-1.418-1.418 3.874-3.874 1.418 1.418a1.2 1.2 0 0 0 1.411.21 12.264 12.264 0 0 1 2.213-.918 1.2 1.2 0 0 0 .849-1.146v-2h5.478v2a1.2 1.2 0 0 0 .849 1.146 12.252 12.252 0 0 1 2.213.918 1.2 1.2 0 0 0 1.411-.21l1.418-1.418 3.877 3.874-1.418 1.415a1.2 1.2 0 0 0-.21 1.411 12.264 12.264 0 0 1 .918 2.213 1.2 1.2 0 0 0 1.146.849h2v5.478h-2a1.2 1.2 0 0 0-1.146.849 12.282 12.282 0 0 1-.918 2.213 1.2 1.2 0 0 0 .21 1.411l1.418 1.421Zm4.874-6.652c.1-.237.2-.476.292-.718h1.3a2.244 2.244 0 0 0 2.242-2.241v-5.786a2.244 2.244 0 0 0-2.242-2.241H45.2q-.187-.5-.412-.992l.919-.919a2.245 2.245 0 0 0 0-3.171l-3.68-3.68v-7.842h13.736v22.3a27.3 27.3 0 0 0-1.716 5.286Zm42.216 7.065c-2.13 3.689-8.051 6.073-15.084 6.073s-12.973-2.384-15.1-6.073c-2.846-4.929 1.9-15.668 7.968-21.9h14.282c.078 0 .155-.006.231-.012 6.098 6.487 10.109 17.751 7.706 21.912ZM70.4 75.8c0 .519 0 .642 1.35.937 1.134.247 3.244.707 3.244 3.289a3.147 3.147 0 0 1-2.3 3.1v.29a1.2 1.2 0 1 1-2.4 0v-.292a3.493 3.493 0 0 1-1.134-.6A3.144 3.144 0 0 1 68 80.026a1.2 1.2 0 0 1 2.4 0c0 .85.915.893 1.1.893s1.1-.043 1.1-.893c0-.549-.041-.662-1.358-.949C70.1 78.83 68 78.371 68 75.8a3.145 3.145 0 0 1 2.3-3.1v-.291a1.2 1.2 0 1 1 2.4 0v.291a3.145 3.145 0 0 1 2.3 3.1 1.2 1.2 0 0 1-2.4 0 .756.756 0 0 0-.273-.636 1.329 1.329 0 0 0-.826-.256c-.191 0-1.101.043-1.101.892Zm1.1-8.142a10.255 10.255 0 1 0 10.249 10.255 10.266 10.266 0 0 0-10.255-10.255Zm0 18.115a7.86 7.86 0 1 1 7.86-7.86 7.869 7.869 0 0 1-7.866 7.86ZM31.4 66.029a7.586 7.586 0 1 0 7.586 7.586 7.595 7.595 0 0 0-7.586-7.586Zm0 12.776a5.19 5.19 0 1 1 5.19-5.19 5.2 5.2 0 0 1-5.19 5.19Z"/></svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Asset Management</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1"><a href="javascript:void(0)">Asset Management</a></li>';
        echo ($active == "AutomatedDiscovery" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../assets/index.php\">" . $escaper->escapeHtml($lang['AutomatedDiscovery']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "AddDeleteAssets" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../assets/manage_assets.php\">" . $escaper->escapeHtml($lang['ManageAssets']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "ManageAssetGroups" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../assets/manage_asset_groups.php\">" . $escaper->escapeHtml($lang['ManageAssetGroups']) . "</a>\n";
        echo "</li>\n";    
        echo "</ul>\n";
    }
    ...
    {   
        ...
        echo'<li class="slide">';
        echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
        echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 100 100"><path d="M51.074 41.574a14.867 14.867 0 1 0 14.867 14.867 14.883 14.883 0 0 0-14.867-14.867Zm0 27.233a12.367 12.367 0 1 1 12.367-12.366 12.38 12.38 0 0 1-12.367 12.366ZM89.267 85.86 76.509 73.1V13.488a1.25 1.25 0 0 0-1.25-1.25h-5.988V6.25A1.25 1.25 0 0 0 68.021 5H26.092a1.252 1.252 0 0 0-.884.366L10.733 19.842a1.247 1.247 0 0 0-.367.884v58.9a1.25 1.25 0 0 0 1.25 1.25H17.6v5.988a1.25 1.25 0 0 0 1.25 1.25h55.123l6.52 6.52a1.251 1.251 0 0 0 1.768 0l7.006-7.007a1.248 1.248 0 0 0 0-1.767ZM74.009 14.738v56a1.249 1.249 0 0 0-1.368.262l-.676.676-4.407-4.406a19.792 19.792 0 0 0 1.711-18.456V14.738ZM61.152 70.405a17.212 17.212 0 1 1 3.887-3.887 1.289 1.289 0 0 0-.219.3 17.442 17.442 0 0 1-3.371 3.372 1.2 1.2 0 0 0-.297.215Zm3.865-.022q.532-.532 1.02-1.1l4.16 4.161-2.119 2.118-4.16-4.16q.564-.483 1.099-1.019ZM24.842 9.268v10.208H14.634ZM12.866 21.976h13.226a1.25 1.25 0 0 0 1.25-1.25V7.5h39.429v37a19.963 19.963 0 0 0-1.754-2A19.7 19.7 0 1 0 61.9 72.922l4.409 4.409-.676.676a1.231 1.231 0 0 0-.254.369H12.866ZM20.1 85.614v-4.738h46.635l4.738 4.739Zm61.273 6.368L68.286 78.891l5.239-5.239 13.091 13.091ZM60.182 49.868a3.157 3.157 0 0 0-4.457 0l-6.358 6.358-2.943-2.944a3.152 3.152 0 0 0-4.457 4.457l5.343 5.343a2.91 2.91 0 0 0 4.115 0l8.757-8.756a3.158 3.158 0 0 0 0-4.458Zm-1.768 2.69-8.757 8.757a.412.412 0 0 1-.579 0l-5.344-5.344a.658.658 0 0 1 0-.921.66.66 0 0 1 .922 0l3.828 3.827a1.249 1.249 0 0 0 1.767 0l7.241-7.241a.66.66 0 0 1 .922 0 .657.657 0 0 1 0 .922ZM22.645 26.509a1.25 1.25 0 0 1 1.25-1.25h28.661a1.25 1.25 0 0 1 0 2.5H23.9a1.25 1.25 0 0 1-1.255-1.25Zm0 6.428a1.25 1.25 0 0 1 1.25-1.25h28.661a1.25 1.25 0 1 1 0 2.5H23.9a1.25 1.25 0 0 1-1.255-1.25Zm0 6.429a1.25 1.25 0 0 1 1.25-1.25h9.8a1.25 1.25 0 0 1 0 2.5H23.9a1.25 1.25 0 0 1-1.255-1.25ZM31.52 45.8a1.25 1.25 0 0 1-1.25 1.25H23.9a1.25 1.25 0 1 1 0-2.5h6.37a1.25 1.25 0 0 1 1.25 1.25Zm-8.875 6.428a1.25 1.25 0 0 1 1.25-1.25h4.875a1.25 1.25 0 0 1 0 2.5H23.9a1.25 1.25 0 0 1-1.255-1.255Zm0 6.429A1.25 1.25 0 0 1 23.9 57.4h3.161a1.25 1.25 0 0 1 0 2.5H23.9a1.25 1.25 0 0 1-1.255-1.248Zm8.232 6.428a1.249 1.249 0 0 1-1.25 1.25H23.9a1.25 1.25 0 1 1 0-2.5h5.732a1.25 1.25 0 0 1 1.245 1.245Z"/></svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Assessments</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1"><a href="javascript:void(0)">Assessments</a></li>';
        echo ($active == "SelfAssessments" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../assessments/index.php\"> " . $escaper->escapeHtml($lang['SelfAssessments']) . "</a>\n";
        echo "</li>\n";
    ...
    echo'<li class="slide">';
    echo ($url == 'reports' ? '<a class="side-menu__item active is-expanded" data-bs-toggle="slide" href="javascript:void(0)">' : '<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">');
    // echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
    echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xml:space="preserve"><path d="M339.387 171.677c-4.447 0-8.374-3.212-9.13-7.745-8.12-48.726-47.875-57.222-48.274-57.302a9.267 9.267 0 0 1 3.633-18.173c2.147.43 52.721 11.224 62.922 72.428.841 5.048-2.569 9.823-7.617 10.664a9.313 9.313 0 0 1-1.534.128z"/><path d="M385.729 338.471h-7.471a9.267 9.267 0 0 1-9.263-9.532c.032-1.145.054-2.291.054-3.441 0-64.38-52.377-116.757-116.756-116.757-64.38 0-116.757 52.377-116.757 116.757 0 .956.015 1.907.039 2.855a9.267 9.267 0 0 1-9.228 10.118h-18.611a9.241 9.241 0 0 1-2.524-.35c-36.123-10.229-62.34-47.563-62.34-88.771 0-39.171 26.063-73.546 62.95-84.409 2.913-37.164 33.989-66.511 71.77-66.511 7.23 0 14.304 1.064 21.123 3.171a103.888 103.888 0 0 1 33.38-34.32c16.515-10.512 35.627-16.067 55.268-16.067 56.99 0 103.356 46.52 103.356 103.701 0 2.297-.08 4.613-.237 6.936 44.117 4.549 78.646 42.055 78.646 87.5 0 48.488-36.502 87.633-83.103 89.117-.099.001-.197.003-.296.003zm-276.655-18.533h8.042c2.926-72.031 62.44-129.729 135.177-129.729 72.705 0 132.199 57.652 135.172 129.638 35.563-2.225 63.129-32.791 63.129-70.497 0-38.284-31.018-69.43-69.142-69.43-.155 0-.311.007-.463.013-.233.008-.468.016-.701.021-2.771.028-5.389-1.129-7.188-3.215a9.265 9.265 0 0 1-2.119-7.583 86.406 86.406 0 0 0 1.203-14.241c0-46.962-38.052-85.168-84.823-85.168-32.48 0-61.623 18.18-76.051 47.446a9.269 9.269 0 0 1-12.081 4.367 52.854 52.854 0 0 0-21.638-4.596c-29.478 0-53.46 24.085-53.46 53.691 0 .238.01.475.018.711l.02.635a9.267 9.267 0 0 1-7.418 9.305c-32.069 6.516-55.345 35.133-55.345 68.044-.001 32.625 19.973 62.084 47.668 70.588z"/><path d="M252.293 460.788c-35.444 0-68.95-13.612-94.345-38.327-25.343-24.666-39.862-57.689-40.881-92.988a134.287 134.287 0 0 1-.063-3.975c0-74.599 60.69-135.29 135.29-135.29s135.29 60.69 135.29 135.29c0 1.328-.023 2.652-.063 3.972-1.021 35.302-15.538 68.325-40.883 92.991-25.395 24.715-58.902 38.327-94.345 38.327zm0-252.047c-64.38 0-116.757 52.377-116.757 116.757 0 1.148.021 2.293.055 3.436 1.836 63.547 53.097 113.321 116.702 113.321 63.604 0 114.867-49.774 116.703-113.317.032-1.142.054-2.287.054-3.438 0-64.382-52.377-116.759-116.757-116.759z"/><path d="M330.14 432.989a9.256 9.256 0 0 1-7.719-4.127L251.48 322.449l-123.968 15.945c-5.078.651-9.72-2.934-10.373-8.008-.653-5.076 2.933-9.721 8.009-10.373l129.671-16.68a9.256 9.256 0 0 1 8.892 4.05l74.131 111.197a9.268 9.268 0 0 1-7.702 14.409z"/><path d="M163.333 423.722a9.233 9.233 0 0 1-6.23-2.408c-3.787-3.442-4.066-9.305-.624-13.091l92.664-101.931c3.442-3.787 9.304-4.065 13.089-.623 3.787 3.442 4.065 9.304.623 13.089L170.191 420.69a9.241 9.241 0 0 1-6.858 3.032zm83.4-268.726h18.533v18.533h-18.533zm-27.798 0h18.533v18.533h-18.533zm-27.8 0h18.533v18.533h-18.533z"/></svg>';
    echo'<span class="side-menu__label" style="font-size:15px;">Reporting</span><i';
    echo'class="angle fe fe-chevron-right"></i></a>';
            // Done

    echo'<ul class="slide-menu">';
    echo'<li class="side-menu__label1"><a href="javascript:void(0)">Reporting</a></li>';
    echo ($active == "Overview" ? "<li class=\"active\" style='background-color: #4deeea1a;border-radius: 5px;'>\n" : "<li>\n");
    echo ($active == "Overview" ? "<a class=\"slide-item active\" href=\"../reports/index.php\" style='font-size:15px;'>" . $escaper->escapeHtml($lang['Overview']) . "</a>\n" : "<a class=\"slide-item\" href=\"../reports/index.php\" style='font-size:15px;'>" . $escaper->escapeHtml($lang['Overview']) . "</a>\n");
    echo "</li>\n";
    echo ($active == "RiskDashboard" ? "<li class=\"active\" style='background-color: #4deeea1a;border-radius: 5px;'>\n" : "<li>\n");
    echo ($active == "RiskDashboard" ? "<a class=\"slide-item active\" href=\"../reports/dashboard.php\">" . $escaper->escapeHtml($lang['RiskDashboard']) . "</a>\n" : "<a class=\"slide-item\" href=\"../reports/dashboard.php\">" . $escaper->escapeHtml($lang['RiskDashboard']) . "</a>\n");
    echo "</li>\n";
    echo ($active == "RisksAndIssues" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risks_and_issues.php\">" . $escaper->escapeHtml($lang['RisksAndIssues']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RiskAppetiteReport" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risk_appetite.php\">" . $escaper->escapeHtml($lang['RiskAppetiteReport']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RiskTrend" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/trend.php\">" . $escaper->escapeHtml($lang['RiskTrend']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "DynamicRiskReport" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/dynamic_risk_report.php\">" . $escaper->escapeHtml($lang['DynamicRiskReport']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "GraphicalRiskAnalysis" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/graphical_risk_analysis.php\">" . $escaper->escapeHtml($lang['GraphicalRiskAnalysis']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "ConnectivityVisualizer" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/connectivity_visualizer.php\">" . $escaper->escapeHtml($lang['ConnectivityVisualizer']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RiskAverageOverTime" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risk_average_baseline_metric.php\">" . $escaper->escapeHtml($lang['RiskAverageOverTime']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "LikelihoodImpact" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/likelihood_impact.php\">" . $escaper->escapeHtml($lang['LikelihoodImpact']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RiskAdvice" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/riskadvice.php\">" . $escaper->escapeHtml($lang['RiskAdvice']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RisksAndAssets" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risks_and_assets.php\">" . $escaper->escapeHtml($lang['RisksAndAssets']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "RisksAndControls" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risks_and_controls.php\">" . $escaper->escapeHtml($lang['RisksAndControls']) . "</a>\n";
    echo "</li>\n";    
    echo ($active == "AllOpenRisksAssignedToMeByRiskLevel" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/my_open.php\">" . $escaper->escapeHtml($lang['AllOpenRisksAssignedToMeByRiskLevel']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "AllOpenRisksNeedingReview" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/review_needed.php\">" . $escaper->escapeHtml($lang['AllOpenRisksNeedingReview']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "AllOpenRisksByTeam" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/risks_open_by_team.php?id=true&risk_status=true&subject=true&calculated_risk=true&submission_date=true&team=true&mitigation_planned=true&management_review=true&owner=true&manager=true\">" . $escaper->escapeHtml($lang['AllOpenRisksByTeamByLevel']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "HighRiskReport" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/high.php\">" . $escaper->escapeHtml($lang['HighRiskReport']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "SubmittedRisksByDate" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/submitted_by_date.php\">" . $escaper->escapeHtml($lang['SubmittedRisksByDate']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "MitigationsByDate" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/mitigations_by_date.php\">" . $escaper->escapeHtml($lang['MitigationsByDate']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "ManagementReviewsByDate" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/mgmt_reviews_by_date.php\">" . $escaper->escapeHtml($lang['ManagementReviewsByDate']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "ClosedRisksByDate" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/closed_by_date.php\">" . $escaper->escapeHtml($lang['ClosedRisksByDate']) . "</a>\n";
    echo "</li>\n";
    echo ($active == "CurrentRiskComments" ? "<li class=\"active\">\n" : "<li>\n");
    echo "<a class=\"slide-item\" href=\"../reports/recent_commented.php\">" . $escaper->escapeHtml($lang['CurrentRiskComments']) . "</a>\n";
    echo "</li>\n";
    echo "</ul>\n";
    // If the user is logged in as an administrator
    if (isset($_SESSION["admin"]) && $_SESSION["admin"] == "1")
    {
        echo'<li class="slide">';
        echo'<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">';
        echo'<svg class="ionicon side-menu__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125"><path style="text-indent:0;text-transform:none;direction:ltr;block-progression:tb;baseline-shift:baseline;color:#000;enable-background:accumulate" d="M44.688 957.366a3 3 0 0 0-2.563 2.094l-3.469 11a34.037 34.037 0 0 0-3.218 1.343l-10.22-5.312a3 3 0 0 0-3.5.531l-7.062 7.062a3 3 0 0 0-.531 3.5l5.313 10.218a34.035 34.035 0 0 0-1.344 3.219l-11 3.469A3 3 0 0 0 5 997.364v10a3 3 0 0 0 2.094 2.875l11 3.469a34.04 34.04 0 0 0 1.343 3.218l-5.312 10.218a3 3 0 0 0 .531 3.5l7.063 7.062a3 3 0 0 0 3.5.532l10.218-5.313c1.047.496 2.124.957 3.22 1.344l3.468 11a3 3 0 0 0 2.875 2.093h10a3 3 0 0 0 2.875-2.094l3.469-10.999a34.024 34.024 0 0 0 3.218-1.344l10.22 5.313a3 3 0 0 0 3.5-.532l7.062-7.062a3 3 0 0 0 .531-3.5l-5.313-10.218a34.04 34.04 0 0 0 1.344-3.218l11-3.47a3 3 0 0 0 2.094-2.874v-10a3 3 0 0 0-2.094-2.874l-11-3.469a34.035 34.035 0 0 0-1.344-3.219l5.313-10.218a3 3 0 0 0-.531-3.5l-7.063-7.062a3 3 0 0 0-3.594-.5l-2.156 1.219a3.008 3.008 0 1 0 2.938 5.25l.187-.094 3.906 3.906-4.937 9.468a3 3 0 0 0 .031 2.813 27.561 27.561 0 0 1 2.156 5.25 3 3 0 0 0 1.97 2.03L89 999.585v5.561l-10.219 3.219a3 3 0 0 0-1.969 2.031 27.56 27.56 0 0 1-2.156 5.25 3 3 0 0 0-.031 2.812l4.938 9.469-4 4-9.47-4.938a3 3 0 0 0-2.812.031 27.57 27.57 0 0 1-5.25 2.156 3 3 0 0 0-2.031 1.97l-3.219 10.217H47.22L44 1031.144a3 3 0 0 0-2.031-1.969 27.57 27.57 0 0 1-5.25-2.156 3 3 0 0 0-2.813-.03l-9.468 4.937-4-4 4.937-9.468a3 3 0 0 0-.031-2.813 27.56 27.56 0 0 1-2.157-5.25 3 3 0 0 0-1.968-2.03L11 1005.144v-5.562l10.219-3.218a3 3 0 0 0 1.968-2.032 27.561 27.561 0 0 1 2.157-5.25 3 3 0 0 0 .031-2.812l-4.938-9.468 4-4 9.47 4.937a3 3 0 0 0 2.812-.03 27.564 27.564 0 0 1 5.25-2.157A3 3 0 0 0 44 973.584l3.219-10.218h5.562L56 973.584a3 3 0 0 0 2.031 1.969 27.5 27.5 0 0 1 5.25 2.156 3 3 0 1 0 2.875-5.25c-1.52-.821-3.175-1.421-4.812-2l-3.469-11A3 3 0 0 0 55 957.367H45a3 3 0 0 0-.313 0z" overflow="visible" transform="translate(0 -952.362)"/></svg>';
        echo'<span class="side-menu__label" style="font-size:15px;">Configure</span><i';
        echo'class="angle fe fe-chevron-right"></i></a>';
                // Done

        echo'<ul class="slide-menu">';
        echo'<li class="side-menu__label1"><a href="javascript:void(0)">Configure</a></li>';
        if (getTypeOfColumn('mgmt_reviews', 'next_review') == 'varchar') {
            echo ($active == "FixReviewDates" ? "<li class=\"active\">\n" : "<li>\n");
            echo "<a class=\"slide-item\" href=\"../admin/fix_review_dates.php\"><i class=\"fa fa-exclamation-circle\" aria-hidden=\"true\" style=\"color: " . ($active == "FixReviewDates" ? "white": "#bd081c") . "; padding-right: 5px;\"></i>" . $escaper->escapeHtml($lang['FixReviewDates']) . "</a>\n";
            echo "</li>\n";
        }
        if (has_files_with_encoding_issues()) {
            echo ($active == "FixFileEncodingIssues" ? "<li class=\"active\">\n" : "<li>\n");
            echo "<a class=\"slide-item\" href=\"../admin/fix_upload_encoding_issues.php\"><i class=\"fa fa-exclamation-circle\" aria-hidden=\"true\" style=\"color: " . ($active == "FixFileEncodingIssues" ? "white": "#bd081c") . "; padding-right: 5px;\"></i>" . $escaper->escapeHtml($lang['FixFileEncodingIssues']) . "</a>\n";
            echo "</li>\n";
        }
        echo ($active == "Settings" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/index.php\">" . $escaper->escapeHtml($lang['Settings']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "Content" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/content.php\">" . $escaper->escapeHtml($lang['Content']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "RiskAndThreatCatalog" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/risk_catalog.php\">" . $escaper->escapeHtml($lang['RiskAndThreatCatalog']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "ConfigureRiskFormula" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/configure_risk_formula.php\">" . $escaper->escapeHtml($lang['ConfigureRiskFormula']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "ConfigureReviewSettings" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/review_settings.php\">" . $escaper->escapeHtml($lang['ConfigureReviewSettings']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "AddAndRemoveValues" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/add_remove_values.php\">" . $escaper->escapeHtml($lang['AddAndRemoveValues']) . "</a>\n";
        echo "</li>\n";
        if (organizational_hierarchy_extra()) {
            echo ($active == "OrganizationalHierarchy" ? "<li class=\"active\">\n" : "<li>\n");
            echo "<a href=\"organizational_hierarchy.php\">" . $escaper->escapeHtml($lang['OrganizationManagement']) . "</a>\n";
        ...
        echo ($active == "RoleManagement" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/role_management.php\">" . $escaper->escapeHtml($lang['RoleManagement']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "UserManagement" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/user_management.php\">" . $escaper->escapeHtml($lang['UserManagement']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "RedefineNamingConventions" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/custom_names.php\">" . $escaper->escapeHtml($lang['RedefineNamingConventions']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "AssetValuation" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/assetvaluation.php\">" . $escaper->escapeHtml($lang['AssetValuation']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "DeleteRisks" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/delete_risks.php\">" . $escaper->escapeHtml($lang['DeleteRisks']) . "</a>\n";
        echo "</li>\n";
        echo ($active == "AuditTrail" ? "<li class=\"active\">\n" : "<li>\n");
        echo "<a class=\"slide-item\" href=\"../admin/audit_trail.php\">" . $escaper->escapeHtml($lang['AuditTrail']) . "</a>\n";
        echo "</li>\n";
        echo "</ul>\n";
    }
}
...
* FUNCTION: New CSS *
**********************************/
function display_new_css(){
    echo'<link href="../backend/css/icons.css" rel="stylesheet">';
    echo'<link id="style" href="../backend/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />';
    echo'<link href="../backend/css/style.css" rel="stylesheet">';
    echo'<link href="../backend/css/plugins.css" rel="stylesheet">';
}
/**********************************
* FUNCTION: New Js *
**********************************/
function display_new_js(){
     echo'<script src="../zem_glass_assets/assets/plugins/jquery/jquery.min.js"></script>';
//
    echo'<script src="../backend/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>';
    echo'<script src="../backend/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>';
    echo'<script src="../backend/plugins/perfect-scrollbar/p-scroll.js"></script>';
    echo'<script src="../backend/plugins/side-menu/sidemenu.js"></script>';
    echo'<script src="../backend/js/sticky.js"></script>';
    echo'<script src="../backend/plugins/sidebar/sidebar.js"></script>';
    echo'<script src="../backend/plugins/sidebar/sidebar-custom.js"></script>';
    echo'<script src="../backend/js/custom-switcher.js"></script>';
    echo'<script src="../backend/js/custom.js"></script>';

	echo'	<script src="../backend/plugins/ionicons/ionicons.js"></script>';
	echo'	<script src="../backend/plugins/moment/moment.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/jquery.dataTables.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/dataTables.bootstrap5.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/dataTables.buttons.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/buttons.bootstrap5.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/jszip.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/pdfmake/pdfmake.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/pdfmake/vfs_fonts.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/buttons.html5.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/buttons.print.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/js/buttons.colVis.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/dataTables.responsive.min.js"></script>';
	echo'	<script src="../backend/plugins/datatable/responsive.bootstrap5.min.js"></script>';
//	echo'	<script src="../backend/js/table-data.js"></script>';
	echo'	<script src="../backend/plugins/select2/js/select2.full.min.js"></script>';
	echo'	<script src="../backend/js/eva-icons.min.js"></script>';
//
//
}
/***************************
* FUNCTION: NEW TOP MENU *
***************************/
function new_top_menu(){
    global $escaper;
    ...
    // $name = $user_info['name'];
    echo'<div class="main-header side-header sticky nav nav-item">';
    echo'<div class=" main-container container-fluid">';
    echo'<div class="main-header-left">';
    echo'<div class="responsive-logo">';
    echo'<a href="#" class="header-logo">';
    echo'<img src="../images/logo@2x.png" class="mobile-logo dark-logo-1" alt="logo">';
    echo'<img src="../images/logo@2x.png" class="mobile-logo-1 dark-logo-1" alt="logo">';
    echo'</a>';
    echo'</div>';
    echo'<div class="app-sidebar__toggle" data-bs-toggle="sidebar">';
    echo'<!-- <div class="icon"></div> -->';
    echo'<a class="open-toggle" href="javascript:void(0)">';
    echo'<i class="header-icon fe fe-align-left"></i></a>';
    echo'<a class="close-toggle" href="javascript:void(0)"><i class="header-icon fe fe-x"></i></a>';
    echo'</div>';
    echo'<div class="logo-horizontal">';
    echo'<a href="index.html" class="header-logo">';
    echo'<img src="../images/logo@2x.png" class="mobile-logo dark-logo-1" alt="logo">';
    echo'<img src="../images/logo@2x.png" class="mobile-logo-1 dark-logo-1" alt="logo">';
    echo'</a>';
    echo'</div>';
    echo'<div class="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">';
    echo'<input class="form-control" placeholder="Search..." type="search">';
    echo'<button class="btn br-te-4 br-be-4"><i class="fas fa-search"></i></button>';
    echo'</div>';
    echo'</div>';
    echo'<div class="main-header-right">';
    echo'<button class="navbar-toggler navresponsive-toggler d-lg-none ms-auto" type="button"';
    echo'data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent-4"';
    echo'aria-controls="navbarSupportedContent-4" aria-expanded="false"';
    echo'aria-label="Toggle navigation">';
    echo'<span class="navbar-toggler-icon fe fe-more-vertical"></span>';
    echo'</button>';
    echo'<div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">';
    echo'<div class="collapse navbar-collapse" id="navbarSupportedContent-4">';
    echo'<ul class="nav nav-item header-icons navbar-nav-right ms-auto">';
    echo '<li class="dropdown nav-item">
    <a class="new nav-link" data-bs-target="#country-selector" data-bs-toggle="modal" href="javascript:void(0)"><svg class="ionicon header-icon-svgs" viewBox="0 0 512 512">
            <title>Language</title>
            <path d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208 208-93.13 208-208S370.87 48 256 48z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
            <path d="M256 48c-58.07 0-112.67 93.13-112.67 208S197.93 464 256 464s112.67-93.13 112.67-208S314.07 48 256 48z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
            <path d="M117.33 117.33c38.24 27.15 86.38 43.34 138.67 43.34s100.43-16.19 138.67-43.34M394.67 394.67c-38.24-27.15-86.38-43.34-138.67-43.34s-100.43 16.19-138.67 43.34" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"></path>
            <path fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32" d="M256 48v416M464 256H48"></path>
        </svg></a>
        </li>';
    echo'<li class="dropdown nav-item">';
    echo'<a class="new nav-link theme-layout nav-link-bg layout-setting">';
    echo'<span class="dark-layout"><svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>Dark Theme</title>';
    echo'<path';
    echo'd="M160 136c0-30.62 4.51-61.61 16-88C99.57 81.27 48 159.32 48 248c0 119.29 96.71 216 216 216 88.68 0 166.73-51.57 200-128-26.39 11.49-57.38 16-88 16-119.29 0-216-96.71-216-216z"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'</svg></span>';
    echo'<span class="light-layout"><svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>Light Theme</title>';
    echo'<path fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-miterlimit="10" stroke-width="32"';
    echo'd="M256 48v48M256 416v48M403.08 108.92l-33.94 33.94M142.86 369.14l-33.94 33.94M464 256h-48M96 256H48M403.08 403.08l-33.94-33.94M142.86 142.86l-33.94-33.94" />';
    echo'<circle cx="256" cy="256" r="80" fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-miterlimit="10"';
    echo'stroke-width="32" />';
    echo'</svg></span>';
    echo'</a>';
    echo'</li>';
    echo'<li class="dropdown nav-item  main-header-message">';
    echo'<a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0)"><svg class="ionicon header-icon-svgs"';
    echo'viewBox="0 0 512 512">';
    echo'<title>Messages</title>';
    echo'<rect x="48" y="96" width="416" height="320" rx="40" ry="40" fill="none"';
    echo'stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"';
    echo'stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32"';
    echo'd="M112 160l144 112 144-112" />';
    echo'</svg><span class="badge bg-secondary-transparent tx-secondary header-badge">5</span></a>';
    echo'<div class="dropdown-menu">';
    echo'<div class="p-3 text-start border-bottom">';
    echo'<div class="d-flex align-items-center">';
    echo'<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Messages';
    echo'</h6>';
    echo'<a href="chat.html"';
    echo'class="btn btn-sm btn-primary ms-auto my-auto float-end tx-13">View';
    echo'All</a>';
    echo'</div>';
    echo'<span class="tx-muted tx-11">You have 5 unread messages</span>';
    echo'</div>';
    echo'<ul class="list-unstyled main-message-list chat-scroll">';
	echo'<li class="mb-0">';
    echo'<div class="d-flex pd-x-13 py-2 pos-relative">';
    echo'<a href="chat.html" class="masked-link"></a>';
    echo'<div class="mg-e-10">';
    echo'<span class="avatar-sm"><img alt=""';
    echo'src="../zem_glass_assets/assets/img/users/5.jpg"';
    echo'class="rounded-circle"></span>';
    echo'</div>';
    echo'<div class="flex-1">';
    echo'<div class="flex-between mb-1">';
    echo'<p class="mb-0 tx-default tx-13 font-weight-semibold mb-0">Socrates Itumay</p> <span';
    echo'class="tx-muted tx-11 align-self-start min-w-fit-content">2';
    echo'hr</span>';
    echo'</div>';
    echo'<p class="mb-0 tx-12 tx-muted">Consetetur sanctus consetetur';
    echo'amet amet stet,.</p>';
    echo'</div>';
    echo'</div>';
    echo'</li>';
    echo'</ul>';
    echo'<div class="text-center dropdown-footer">';
    echo'<a class="btn btn-primary btn-block text-center"';
    echo'href="javascript:void(0)">MARK ALL AS READ</a>';
    echo'</div>';
    echo'</div>';
    echo'</li>';
    echo'<li class="dropdown nav-item main-header-notification d-flex">';
    echo'<a class="new nav-link" href="javascript:void(0)" data-bs-toggle="dropdown">';
    echo'<svg class="ionicon header-icon-svgs"';
    echo'viewBox="0 0 512 512">';
    echo'<title>Shortcuts</title>';
    echo'<path';
    echo'd="M448 256L272 88v96C103.57 184 64 304.77 64 424c48.61-62.24 91.6-96 208-96v96z"';
    echo'fill="none" stroke="currentColor" stroke-linejoin="round"';
    echo'stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    echo'<div class="dropdown-menu">';
    echo'<div class="p-3 text-start border-bottom">';
    echo'<div class="d-flex align-items-center">';
    echo'<h6 class="dropdown-title mb-1 tx-15 font-weight-semibold">Shortcuts';
    echo'</h6>';
    echo'<ul class="ah-actions actions align-items-center ms-auto d-flex">';
    echo'<li>';
    echo'<a href="javascript:void(0)" class="header-icon-svgs">';
    echo'<i class="fe fe-edit"></i>';
    echo'</a>';
    echo'</li>';
    echo'<li>';
    echo'<a href="javascript:void(0)" class="header-icon-svgs">';
    echo'<i class="fe fe-plus"></i>';
    echo'</a>';
    echo'</li>';
    echo'</ul>';
    echo'</div>';
    echo'<span class="tx-muted tx-11">At nonumy duo dolores ipsum.</span>';
    echo'</div>';
    echo'<ul class="list-unstyled main-shortcut-list text-center p-2">';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="calendar.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top"';
    echo'title="calendar">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>calendar</title>';
    echo'<rect x="48" y="80" width="416" height="384" rx="48"';
    echo'fill="none" stroke="currentColor"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-linejoin="round"';
    echo'stroke-width="32"';
    echo'd="M128 48v32M384 48v32M464 160H48M304 260l43.42-32H352v168M191.87 306.63c9.11 0 25.79-4.28 36.72-15.47a37.9 37.9 0 0011.13-27.26c0-26.12-22.59-39.9-47.89-39.9-21.4 0-33.52 11.61-37.85 18.93M149 374.16c4.88 8.27 19.71 25.84 43.88 25.84 28.59 0 52.12-15.94 52.12-43.82 0-12.62-3.66-24-11.58-32.07-12.36-12.64-31.25-17.48-41.55-17.48" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="contacts.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top"';
    echo'title="contacts">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    ...
    echo'<path';
    echo'd="M402 168c-2.93 40.67-33.1 72-66 72s-63.12-31.32-66-72c-3-42.31 26.37-72 66-72s69 30.46 66 72z"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path';
    echo'd="M336 304c-65.17 0-127.84 32.37-143.54 95.41-2.08 8.34 3.15 16.59 11.72 16.59h263.65c8.57 0 13.77-8.25 11.72-16.59C463.85 335.36 401.18 304 336 304z"';
    echo'fill="none" stroke="currentColor" stroke-miterlimit="10"';
    echo'stroke-width="32" />';
    echo'<path';
    echo'd="M200 185.94c-2.34 32.48-26.72 58.06-53 58.06s-50.7-25.57-53-58.06C91.61 152.15 115.34 128 147 128s55.39 24.77 53 57.94z"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path';
    echo'd="M206 306c-18.05-8.27-37.93-11.45-59-11.45-52 0-102.1 25.85-114.65 76.2-1.65 6.66 2.53 13.25 9.37 13.25H154"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-miterlimit="10" stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="file-manager.html"';
    echo'class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top"';
    ...
    echo'<path';
    echo'd="M440 432H72a40 40 0 01-40-40V120a40 40 0 0140-40h75.89a40 40 0 0122.19 6.72l27.84 18.56a40 40 0 0022.19 6.72H440a40 40 0 0140 40v240a40 40 0 01-40 40zM32 192h448"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="mail-inbox.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top" title="mail">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>mail</title>';
    echo'<rect x="48" y="96" width="416" height="320" rx="40" ry="40"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-linejoin="round"';
    echo'stroke-width="32" d="M112 160l144 112 144-112" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="gallery.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top"';
    echo'title="gallery">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>gallery</title>';
    echo'<rect x="48" y="80" width="416" height="352" rx="48" ry="48"';
    echo'fill="none" stroke="currentColor"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<circle cx="336" cy="176" r="32" fill="none"';
    echo'stroke="currentColor" stroke-miterlimit="10"';
    echo'stroke-width="32" />';
    echo'<path';
    echo'd="M304 335.79l-90.66-90.49a32 32 0 00-43.87-1.3L48 352M224 432l123.34-123.34a32 32 0 0143.11-2L464 368"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="blog.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top" title="blog">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>blog</title>';
    echo'<path';
    echo'd="M368 415.86V72a24.07 24.07 0 00-24-24H72a24.07 24.07 0 00-24 24v352a40.12 40.12 0 0040 40h328"';
    echo'fill="none" stroke="currentColor"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path';
    echo'd="M416 464h0a48 48 0 01-48-48V128h72a24 24 0 0124 24v264a48 48 0 01-48 48z"';
    echo'fill="none" stroke="currentColor"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-linejoin="round"';
    echo'stroke-width="32"';
    echo'd="M240 128h64M240 192h64M112 256h192M112 320h192M112 384h192" />';
    echo'<path';
    echo'd="M176 208h-64a16 16 0 01-16-16v-64a16 16 0 0116-16h64a16 16 0 0116 16v64a16 16 0 01-16 16z" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="shop.html" class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top" title="shop">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>shop</title>';
    echo'<circle cx="176" cy="416" r="16" fill="none"';
    echo'stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<circle cx="400" cy="416" r="16" fill="none"';
    echo'stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-linejoin="round"';
    echo'stroke-width="32" d="M48 80h64l48 272h256" />';
    echo'<path';
    echo'd="M160 288h249.44a8 8 0 007.85-6.43l28.8-144a8 8 0 00-7.85-9.57H128"';
    echo'fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    echo'</li>';
    echo'<li class="d-inline-block m-1">';
    echo'<a href="form-elements.html"';
    echo'class="p-3 dropdown-item border radius-4"';
    echo'data-bs-toggle="tooltip" data-bs-placement="top" title="forms">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>forms</title>';
    echo'<path';
    echo'd="M416 221.25V416a48 48 0 01-48 48H144a48 48 0 01-48-48V96a48 48 0 0148-48h98.75a32 32 0 0122.62 9.37l141.26 141.26a32 32 0 019.37 22.62z"';
    echo'fill="none" stroke="currentColor"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'<path d="M256 56v120a32 32 0 0032 32h120" fill="none"';
    echo'stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32" />';
    echo'</svg>';
    echo'</a>';
    ...
    echo'id="openAllBtn">OPEN ALL</a>';
    echo'</div>';
    echo'</div>';
    echo'</li>';
    echo'<li class="nav-item full-screen fullscreen-button">';
    echo'<a class="new nav-link full-screen-link" href="javascript:void(0)"><svg class="ionicon header-icon-svgs"';
    echo'viewBox="0 0 512 512">';
    echo'<title>Full Width</title>';
    echo'<path fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-linejoin="round" stroke-width="32"';
    echo'd="M432 320v112H320M421.8 421.77L304 304M80 192V80h112M90.2 90.23L208 208M320 80h112v112M421.77 90.2L304 208M192 432H80V320M90.23 421.8L208 304" />';
    echo'</svg></a>';
    echo'</li>';
    echo'<li class="dropdown right-toggle">';
    echo'<a class="new nav-link nav-link pe-0" data-bs-toggle="sidebar-right"';
    echo'<svg class="ionicon header-icon-svgs"';
    echo'viewBox="0 0 512 512">';
    echo'<title>Side Menu</title>';
    echo'<path fill="none" stroke="currentColor" stroke-linecap="round"';
    echo'stroke-miterlimit="10" stroke-width="32"';
    echo'd="M80 160h352M80 256h352M80 352h352" />';
    echo'</svg>';
    echo'<span class="pulse"></span>';
    echo'</a>';
    echo'</li>';
    echo'<li class="search-icon d-lg-none d-block">';
    echo'<form class="navbar-form" role="search">';
    echo'<div class="input-group">';
    echo'<input type="text" class="form-control" placeholder="Search">';
    echo'<span class="input-group-btn">';
    echo'<button type="reset" class="btn btn-default">';
    echo'<i class="fas fa-times"></i>';
    echo'</button>';
    echo'<button type="submit" class="btn btn-default nav-link resp-btn">';
    echo'<svg';
    echo'class="ionicon header-icon-svgs" viewBox="0 0 512 512">';
    echo'<title>Search</title>';
    echo'<path';
    echo'd="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z"';
    echo'fill="none" stroke="currentColor" stroke-miterlimit="10"';
    echo'stroke-width="32" />';
    echo'<path fill="none" stroke="currentColor"';
    echo'stroke-linecap="round" stroke-miterlimit="10"';
    echo'stroke-width="32" d="M338.29 338.29L448 448" />';
    echo'</svg>';
    echo'</button>';
    echo'</span>';
    echo'</div>';
    echo'</form>';
    echo'</li>';
    echo'<li class="dropdown main-profile-menu nav-item">';
    echo'<a class="new nav-link profile-user rounded-circle shadow d-flex"';
    echo'href="javascript:void(0)" data-bs-toggle="dropdown"><img alt=""';
    echo'src="../zem_glass_assets/assets/img/users/profile.png"></a>';
    echo'<ul class="dropdown-menu">';
    echo'<li class="bg-primary p-3 br-ts-5 br-te-5 ">';
    echo'<div class="d-flex wd-100p">';
    echo'<div class="avatar"><img alt="avatar" class="rounded-circle"';
    echo'src="../zem_glass_assets/assets/img/users/profile.png"></div>';
    echo'<div class="ms-3 my-auto">';
    echo'<h6 class="tx-15 text-black font-weight-semibold mb-0">Json';
    echo $escaper->escapeHtml($name);
    echo'Taylor</h6><span class="text-black op-8 tx-11">Admin';
    echo'</span>';
    echo'</div>';
    echo'</div>';
    echo'</li>';
    echo'<li><a class="dropdown-item" href="profile.html"><i';
    echo'class="fe fe-user"></i>Profile</a></li>';
    echo'<li><a class="dropdown-item" href="mail-read.html"><i';
    echo'class="fe fe-power"></i>Log Out</a></li>';
    echo'</ul>';
    echo'</li>';
    echo'</ul>';
    echo'</div>';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="row p-3 list-unstyled mb-0">
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block active"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/us_flag.jpg" class="me-3 language"></span>Usa </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/italy_flag.jpg" class="me-3 language"></span>Italy </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/spain_flag.jpg" class="me-3 language"></span>Spain </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/india_flag.jpg" class="me-3 language"></span>India </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/french_flag.jpg" class="me-3 language"></span>France </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/mexico.jpg" class="me-3 language"></span>Mexico </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/singapore.jpg" class="me-3 language"></span>Singapore </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/poland.jpg" class="me-3 language"></span>Poland </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/austria.jpg" class="me-3 language"></span>Austria </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/russia_flag.jpg" class="me-3 language"></span>Russia </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/germany_flag.jpg" class="me-3 language"></span>Germany </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/argentina.jpg" class="me-3 language"></span>Argentina </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/brazil.jpg" class="me-3 language"></span>Brazil </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/uae.jpg" class="me-3 language"></span>U.A.E </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/china.jpg" class="me-3 language"></span>China </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/uk.jpg" class="me-3 language"></span>U.K </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/malaysia.jpg" class="me-3 language"></span>Malaysia </a> </li>
                    <li class="col-lg-6 mb-2"> <a href="#" class="btn btn-country btn-lg btn-block"> <span class="country-selector"><img alt="" src="../zem_glass_assets/assets/img/flags/canada.jpg" class="me-3 language"></span>Canada </a> </li>
                </ul>
            </div>
        </div>
    </div>
...
///////////// Password Policy Functionn Design  ///////////////////

function generatePasswordPolicy() {
  echo '
  <div style="position: relative; padding: 20px; width:250px; margin:0; background: linear-gradient(180deg, rgba(34, 85, 92, 0.8), rgba(34, 85, 92, 0.3)); border-radius: 10px; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
  <div style="position: absolute; top: -5px; left: -5px; width: calc(100% + 10px); height: calc(100% + 10px); border: 2px solid rgba(54, 156, 158, 0.5); border-radius: 10px; backdrop-filter: blur(10px);"></div>
  
  <div style="position: relative; z-index: 1; background-color: rgba(0, 0, 0, 0.4); padding: 10px; border-radius: 10px;">
    <h2 style="color: #369C9E; font-size: 24px; margin-bottom: 20px;">Password Rules</h2>
    <ul style="color: #369C9E; font-size: 18px; line-height: 1.5;">
