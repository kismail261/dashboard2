  ...
  <div class="row-fluid">
        ...
        <div class="span12">
          <div class="hero-unit">
            ...
            <tr>
              ...
              <td>Enables an API for integration of GRCfy with other tools and automation tasks.</td>
              <td width="60px"><?php echo (api_extra() ? '<a href="api.php">Yes</a>' : '<a href="api.php">No</a>'); ?></td>
            </tr>
    <!--
            <tr>
              <td width="155px"><b>ComplianceForge DSP</b></td>
              <td>Adds the controls from the <a href="https://www.complianceforge.com/digital-security-program-dsp/" target="_blank">ComplianceForge Digital Security Program (DSP)</a> into GRCfy for use with our Governance functionality.</td>
    ...
    -->
            <tr>
              ...
              <td>Adds the controls from the <a href="https://www.securecontrolsframework.com/" target="_blank">ComplianceForge Secure Controls Framework (SCF)</a> into GRCfy for use with our Governance functionality.</td>
    ...
    -->
            ...
            <tr>
              ...
              <td>Provides incident management capabilities from within the GRCfy system.</td>
            ...
            <tr>
              ...
              <td>Enables the integration of the Unified Control Framework (UCF) controls and tests with GRCfy.</td>
            ...
            <tr>
              ...
              <td>Enables the integration of GRCfy with Rapid7 Nexpose and Tenable.io.</td>
              <td width="60px"><?php echo (vulnmgmt_extra() ? '<a href="vulnmgmt.php">Yes</a>' : '<a href="vulnmgmt.php">No</a>'); ?></td>
            </tr>
            <tbody>
            </table>
            <p>If you are interested in adding these or other custom functionality to your GRCfy installation, please send an e-mail to <a href="mailto:extras@simplerisk.com?Subject=Interest%20in%20GRCfy%20Extras" target="_top">extras@simplerisk.com</a>.</p>
          </div>
        </div>
      </div>
    </div>
