...
require_once(language_file());
	...
	{
		// If GRCfy is already registered
	...
	if (get_setting('registration_registered') == 0)
	{
		...
		if (isset($_POST['register']))
		{
			...
			{
				// Display an alert
				set_alert(true, "bad", "There was a problem registering your GRCfy instance.");
			}
			else
			{
				// Display an alert
				set_alert(true, "good", "GRCfy instance registered successfully.");
	...
	else
	{
		...
		if (isset($_POST['register']))
		{
			...
			{
				// Display an alert
				set_alert(true, "bad", "There was a problem updating your GRCfy instance.");
			}
			else
			{
				// Display an alert
				set_alert(true, "good", "GRCfy instance updated successfully.");
			}
		}
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
            <div class="row-fluid">
                <div class="span12">
                    <div class="hero-unit">
                        <p><h4><?php echo $escaper->escapeHtml($lang['RegisterGRCfy']); ?></h4></p>
            ...
            <div class="row-fluid">
                ...
                <div id="upgrade-panel" class="span6">
                    <div class="hero-unit">
                        <p><h4><?php echo $escaper->escapeHtml($lang['UpgradeGRCfy']); ?></h4></p>
                        <?php
	                        // If the instance is not registered
	                        if (!$registered)
	                        {
