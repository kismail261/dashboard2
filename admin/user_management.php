...
if (isset($_POST['add_user']))
{
    ...
    if ($type == "1")
    {
        // This is a local GRCfy user account
        $type = "simplerisk";
                  ...
                  <tbody>
                    <tr>
                      <td style="width:900px;">
                        ...
                        <form name="add_user" method="post" onsubmit="return validateForm()" action="">
                            <table border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="type" id="select" onChange="handleSelection(value)">
                                            <option selected value="1">GRCfy</option>
                                            <?php
                                ...
                                <tr><td><?php echo $escaper->escapeHtml($lang['Username']); ?>:&nbsp;</td><td><input name="new_user" type="text" maxlength="200" 
                                value="<?php echo isset($user) ? $escaper->escapeHtml($user) : "" ?>" size="20" /></td></tr>
                                
                                <tr>
                                <tr class="ldap_pass"><td><?php echo $escaper->escapeHtml($lang['Password']); ?>:&nbsp;</td><td><input name="password" type="password" id="password"  maxlength="50" size="20" autocomplete="off"
                                ...
                                required /> </td></tr>
                                <tr class="ldap_pass"><td><?php echo $escaper->escapeHtml($lang['RepeatPassword']); ?>:&nbsp;</td><td><input name="repeat_password" type="password" id="confirmPassword" maxlength="50" size="20" autocomplete="off"
                                pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$" 
                                title="Password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, one digit, and one special character."
                                required
                                /></td></tr>
...
?>
                     ...
                     <td width="400px" style="padding:20px; vertical-align:top; border-color:transparent;">
                      <!-- Call the function to generate the password policy section -->
<?php generatePasswordPolicy(); ?>
                     </td>
                    </tr>
                  </tbody>
                </table>
