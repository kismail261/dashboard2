...
// Include the GRCfy functions.php file
...
$saml_trusted_domains = str_replace(' ', '', $saml_trusted_domains);
...
$config = [
     ...
     */
    'technicalcontact_name' => 'GRCfy Support',
     ...
     */
    'trusted.url.domains' => $saml_trusted_domains_array,
     ...
     */
    'session.phpsession.cookiename' => 'SimpleSAMLphp',
     ...
     */
    'session.authtoken.cookiename' => 'AUTHSESSID',
    ...
    'store.sql.dsn'                 => 'mysql:charset=UTF8;dbname='.DB_DATABASE.';host='.DB_HOSTNAME.';port='.DB_PORT,
    ...
    'store.sql.username' => DB_USERNAME,
